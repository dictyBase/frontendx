...
jest.mock("components/features/Summary/Panels/GeneralInfoQuery", () => ({
  GeneralInfoQuery: () => <div data-testid="general-info-query">General Info Query</div>,
}))
...
jest.mock("components/features/Summary/Panels/ReferencesQuery", () => ({
  ReferencesQuery: () => <div data-testid="references-query">References Query</div>,
}))
...
describe("features/Summary/SummaryContainer", () => {
  it("should render all panel components", () => {
    ...
    expect(screen.getByTestId("typography")).toHaveAttribute("data-component", "div")
