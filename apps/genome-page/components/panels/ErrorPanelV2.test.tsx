...
describe("ErrorPanelV2", () => {
  ...
  it("renders with default props", () => {
    ...
    expect(
      screen.getByText("We encountered an unexpected server error while processing your request.")
    ).toBeInTheDocument()
  ...
  it("renders with custom props", () => {
    ...
    render(<ErrorPanelV2 {...customProps} />)
  ...
  it("has the correct styling for mobile and desktop layouts", () => {
    ...
    const headerElement = document.querySelector('[class*="makeStyles-header-"]')
    expect(headerElement).toHaveStyle({
      backgroundColor: '#003366'
    })
    
    // Check that the content wrapper exists
    const contentWrapper = document.querySelector('[class*="makeStyles-contentWrapper-"]')
