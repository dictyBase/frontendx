...
export type Gene = {
  __typename?: 'Gene';
  general_info?: Maybe<Array<GeneralInfo>>;
...
export type GeneralInfo = {
  ...
  alt_protein_name: Scalars['String'];
  description: Scalars['String'];
...
export type ProductInformation = {
  ...
  protein_coding_gene: Scalars['String'];
