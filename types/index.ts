...
export type Links = {
  __typename?: 'Links';
  colleagues: Scalars['String'];
  expression: Scalars['String'];
  ext_resources?: Maybe<Array<Scalars['String']>>;
};
