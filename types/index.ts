...
export type ProductInformation = {
  ...
  genomic_coords?: Maybe<Array<GenomicCoordinates>>;
...
export type QueryListProductInfoArgs = {
  gene: Scalars['String'];
};
