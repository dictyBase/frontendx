...
const clearTableSelection = (editor: LexicalEditor, tableCellNode: TableCellNode) => {
...
const deleteTable = (editor: LexicalEditor, tableCellNode: TableCellNode | undefined) => {
...
const deleteRow = (editor: LexicalEditor, tableCellNode: TableCellNode | undefined) => {
  editor.update(() => {
    if (!tableCellNode) return;
    $removeTableRowAtIndex(
...
const deleteColumn = (editor: LexicalEditor, tableCellNode: TableCellNode | undefined) => {
  if (!tableCellNode) return;
  editor.update(() => {
    $deleteTableColumn(
      $getTableNodeFromLexicalNodeOrThrow(tableCellNode),
