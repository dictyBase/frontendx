...
describe("parseFormattedStringToDomElements", () => {
  it("should parse a string with no formatting tags", () => {
    ...
    expect(result[0].props.children).toBe(input)
  })

  it("should parse a string with a single formatting tag", () => {
  ...
  it("should parse a string with nested formatting tags", () => {
    ...
    expect(result[1].props.children[1].props.children[0].props.children).toBe("italic")
